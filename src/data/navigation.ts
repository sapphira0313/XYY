...
export const DEFAULT_WEBSITE_GROUPS: WebsiteGroup[] = [
  {
    ...
    websites: [
      ...
      { id: 'site142', name: 'Alexa', url: 'https://alexa.amazon.com/', icon: 'https://www.google.com/s2/favicons?domain=alexa.amazon.com&sz=64', type: 'home' },
      { id: 'site7', name: 'Amazon US', url: 'https://www.amazon.com/', icon: 'https://www.google.com/s2/favicons?domain=amazon.com&sz=64', type: 'home' },
      { id: 'site8', name: 'Amazon CA', url: 'https://www.amazon.ca/', icon: 'https://www.google.com/s2/favicons?domain=amazon.ca&sz=64', type: 'home' },
      ...
      { id: 'site11', name: '有道翻译', url: 'https://fanyi.youdao.com/#/TextTranslate', icon: 'https://www.google.com/s2/favicons?domain=youdao.com&sz=64', type: 'translate' },
      ...
      { id: 'site1', name: '记事本', url: 'https://sapphira0313.github.io/Notepad/', icon: 'https://raw.githubusercontent.com/sapphira0313/Zhiniao-Navigation/refs/heads/main/icon-64x64.ico', type: 'document' },
      ...
      { id: 'site24', name: 'GitHub', url: 'https://github.com/', icon: 'https://www.google.com/s2/favicons?domain=github.com&sz=64', type: 'tool' },
      ...
      { id: 'site29', name: 'Gmail', url: 'https://mail.google.com/', icon: 'https://www.google.com/images/icons/product/googlemail-32.png', type: 'email' },
      { id: 'site30', name: 'Outlook', url: 'https://outlook.live.com/mail/', icon: 'https://www.google.com/s2/favicons?domain=outlook.com&sz=64', type: 'email' },
      ...
      { id: 'site23', name: 'ChatGPT', url: 'https://chatgpt.com/', icon: 'https://www.google.com/s2/favicons?domain=openai.com&sz=64', type: 'foreign-ai' },
      ...
      { id: 'site36', name: 'ChatGLM', url: 'https://chat.z.ai/', icon: 'https://www.google.com/s2/favicons?domain=chat.z.ai&sz=64', type: 'domestic-ai' },
      { id: 'site37', name: 'MiniMax', url: 'https://agent.minimax.io/', icon: 'https://www.google.com/s2/favicons?domain=agent.minimax.io&sz=64', type: 'domestic-ai' },
      ...
      { id: 'site114', name: '通义万相 2.2', url: 'https://tongyi.aliyun.com/wan/', icon: 'https://www.google.com/s2/favicons?domain=aliyun.com&sz=64', type: 'video-ai' },
      ...
      { id: 'site119', name: '通义万相', url: 'https://tongyi.aliyun.com/wan/', icon: 'https://www.google.com/s2/favicons?domain=aliyun.com&sz=64', type: 'image-ai' },
      ...
      { id: 'site42', name: 'Burst', url: 'https://burst.shopify.com/', icon: 'https://www.google.com/s2/favicons?domain=burst.shopify.com&sz=64', type: 'design-image' },
      ...
      { id: 'site54', name: 'Adobe Stock', url: 'https://stock.adobe.com/', icon: 'https://www.google.com/s2/favicons?domain=stock.adobe.com&sz=64', type: 'design-image' },
      ...
      { id: 'site102', name: 'Telegram', url: 'https://telegram.org/', icon: 'https://www.google.com/s2/favicons?domain=telegram.org&sz=64', type: 'social' },
...
export function loadStoredWebsiteGroups(): WebsiteGroup[] {
  ...
  try {
    ...
    console.error('Failed to parse saved websites:', error);
    return normalizeWebsiteGroups(DEFAULT_WEBSITE_GROUPS);
  }
}